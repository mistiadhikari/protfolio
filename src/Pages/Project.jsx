...
const Project = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(244,114,182,0.18),_transparent_28%),radial-gradient(circle_at_top_right,_rgba(147,51,234,0.16),_transparent_30%),linear-gradient(180deg,_#fcfbff_0%,_#f7f3ff_45%,_#fffaf6_100%)] py-16 transition-colors duration-300 dark:bg-[radial-gradient(circle_at_top_left,_rgba(236,72,153,0.12),_transparent_28%),radial-gradient(circle_at_top_right,_rgba(99,102,241,0.16),_transparent_30%),linear-gradient(180deg,_#020617_0%,_#0f172a_45%,_#111827_100%)] sm:py-20">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
        <div className="grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-6 max-w-3xl text-3xl font-bold leading-tight text-gray-900 dark:text-slate-100 sm:text-4xl md:text-5xl lg:text-6xl">
              Projects that reflect my learning, creativity, and growth as a developer.
            </h1>

            <p className="mt-5 max-w-2xl text-base text-gray-600 dark:text-slate-300 sm:text-lg">
              A collection of work where I experiment with design, improve my coding
              skills, and turn ideas into interactive digital experiences.
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              {[
                ...
                <div
                  key={item.label}
                  className="min-w-[9rem] rounded-2xl border border-white/80 bg-white/75 px-4 py-4 shadow-lg backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/75 sm:px-5"
                >
                  <p className="text-xs uppercase tracking-[0.2em] text-purple-500">
                    {item.label}
                  </p>
                  <p className="mt-2 text-xl font-semibold text-gray-900 dark:text-slate-100">
                    {item.value}
                  </p>
                </div>
              ))}
          ...
          {featuredProject && (
            <div className="relative mx-auto w-full max-w-xl">
              ...
              <div className="overflow-hidden rounded-[2rem] border border-white/70 bg-white/75 p-4 shadow-2xl backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/75">
                <div className="relative overflow-hidden rounded-[1.5rem]">
                  ...
                  <div className="absolute left-5 top-5 rounded-full bg-white/90 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-gray-800 shadow dark:bg-slate-950/90 dark:text-slate-100">
                    Featured Work
                  </div>
        ...
        <div className="mt-16 flex flex-col items-start justify-between gap-4 lg:flex-row lg:items-center">
          ...
          <div className="flex w-full flex-wrap gap-3 rounded-3xl border border-white/70 bg-white/80 p-2 shadow-md backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/80 lg:w-auto lg:rounded-full">
            {categories.map((cat) => (
              <button
                key={cat}
                ...
                className={`flex-1 rounded-full px-4 py-2 text-sm font-semibold transition sm:flex-none sm:px-5 ${
                  selectedCategory === cat
                    ? "bg-gray-900 text-white shadow-lg dark:bg-slate-100 dark:text-slate-950"
                    : "text-gray-700 hover:bg-purple-50 hover:text-purple-700 dark:text-slate-200 dark:hover:bg-slate-800 dark:hover:text-purple-300"
                }`}
              >
                {cat}
              </button>
        ...
        <div className="mt-10 grid gap-8 md:grid-cols-2 xl:grid-cols-3">
          {filteredProjects.map((project, index) => (
            <article
              ...
              className="group overflow-hidden rounded-[2rem] border border-white/70 bg-white/80 shadow-lg backdrop-blur-md transition duration-300 hover:-translate-y-2 hover:shadow-2xl dark:border-slate-800 dark:bg-slate-900/80"
            >
                ...
                <div className="absolute left-5 top-5">
                  <span
                    className={`inline-flex rounded-full bg-gradient-to-r ${
                      categoryStyles[project.category] || categoryStyles.All
                    } px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-white shadow`}
                  >
                    {project.category}
                  </span>
                </div>
              ...
              <div className="p-6">
                <div className="mb-5 flex items-center gap-2 text-sm font-medium text-gray-500 dark:text-slate-400">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.tech.map((tech) => (
                    <span
                      ...
                      className="rounded-full border border-purple-100 bg-purple-50 px-3 py-1 text-sm font-medium text-purple-700 dark:border-purple-900/70 dark:bg-slate-950 dark:text-purple-300"
                    >
                      {tech}
                    </span>
                  ))}
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl">
              ...
              <h3 className="mt-3 text-2xl font-bold sm:text-3xl">
                Want to see more of my project journey?
              </h3>
              <p className="mt-3 text-purple-100">
                I'm continuously building and improving projects as I learn. You can
                explore more code, experiments, and progress on my GitHub profile.
              </p>
            </div>
